<footer id="about" class="h-auto bg-green-800 flex justify-center text-slate-900">
    <div class="container py-8 flex justify-end">
        <div class="basis-1/4 flex gap-4">
            <img src="{{ asset('assets/images/ZhongliB.png') }}" alt="Logo Zhongli" class="h-60">
        </div>
        <div class="basis-1/4 flex flex-col gap-1">
            <h5 class="text-slate-100 font-bold pb-2">Lokasi & Kontak</h5>
            <div class="bg-green-600 h-36 mr-16 rounded-lg mb-2"></div>
            <a href="#" class="group flex gap-2 p-2 mr-16 rounded-lg hover:bg-green-600 hover:text-white transition ease-in">
        ...
        <div class="basis-1/4 flex flex-col gap-1">
            ...
            <div class="flex flex-row">
                <a href="https://instagram.com/mirvanhakimmm" class="group p-4 rounded-full hover:bg-green-600 transition ease-in">
                ...
                <a href="https://youtube.com/channel/UCjRc-gYlqHi1x9fwCMeVEGw" class="group p-4 rounded-full hover:bg-green-600 transition ease-in">
