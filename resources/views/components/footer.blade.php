<footer id="about" class="h-auto bg-yellow-800 flex justify-center text-slate-900">
    <div class="container py-8 flex justify-end">
        <div class="basis-1/4 flex gap-4">
            <img src="{{ asset('assets/images/Zhongli.png') }}" alt="Logo Zhongli" class="h-60">
        </div>
        <div class="basis-1/4 flex flex-col gap-1">
            <h5 class="text-slate-100 font-bold pb-2">Lokasi & Kontak</h5>
            <div class="bg-yellow-600 h-36 mr-16 rounded-lg mb-2"></div>
            <a href="#" class="group flex gap-2 p-2 mr-16 rounded-lg hover:bg-yellow-600 hover:text-white transition ease-in">
                <svg class="fill-slate-900 group-hover:fill-slate-900 transition ease-in" sxmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm640-480L501-453q-5 3-10.5 4.5T480-447q-5 0-10.5-1.5T459-453L160-640v400h640v-400ZM480-520l320-200H160l320 200ZM160-640v10-59 1-32 32-.5 58.5-10 400-400Z"/></svg>
                <p>mirvanhakimmm@gmail.com</p>
            </a>
            <a href="#" class="group flex gap-2 p-2 mr-16 rounded-lg hover:bg-yellow-600 hover:text-white transition ease-in">
...
<p class="p-4 bg-black text-center text-white">© Copyright 2023 - by Muhammad Irvan Hakim</p>
